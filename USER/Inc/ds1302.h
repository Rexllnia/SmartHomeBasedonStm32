...
#include "sys.h" 
#include "main.h"
#define CE_L HAL_GPIO_WritePin(GPIOA, CE_Pin, GPIO_PIN_RESET)//GPIO_ResetBits(GPIOA,GPIO_Pin_10)//拉低使能位
#define CE_H HAL_GPIO_WritePin(GPIOA, CE_Pin, GPIO_PIN_SET)//拉高使能位
#define SCLK_L HAL_GPIO_WritePin(GPIOA, SCLK_Pin, GPIO_PIN_RESET)//拉低时钟线
#define SCLK_H HAL_GPIO_WritePin(GPIOA, SCLK_Pin, GPIO_PIN_SET)//拉高时钟线
#define DATA_L  HAL_GPIO_WritePin(GPIOA, DATA_Pin, GPIO_PIN_RESET)//拉低数据线
#define DATA_H  HAL_GPIO_WritePin(GPIOA, DATA_Pin, GPIO_PIN_SET)//拉高数据线
